...
Este primer experimento desarrolla una primera aproximación a las 24 trenzas del Sitio Abismal (Vestibles — TTT, Textiles, Técnicas y Tecnologías, 2023): especulaciones que se desprenden del proyecto TTT2 (TTT2 — La Piel Tejida: Codificar y Significar mediante una proto-Escritura).
...
Se utiliza una variación aleatoria controlada.
...
Esto permite explorar una idea central del proyecto:
...
08 — De la variación hacia un sistema de operaciones
...
El experimento todavía no utiliza el diccionario de operaciones ni el QR Abismal como semilla.
...
La intención es pasar de un sistema basado parcialmente en variaciones aleatorias a un sistema basado en operaciones y combinaciones definidas.
